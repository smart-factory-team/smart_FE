...
class WebSocketService {
  ...
  onMonitoringOpen() {
    ...
    console.log('onMonitoringOpen: Notified listeners with CONNECTION_STATUS');
  }
  ...
  onMonitoringMessage(event) {
    try {
      ...
      console.log('onMonitoringMessage: Notifying listeners with MONITORING_DATA');
  ...
  attemptMonitoringReconnect() {
    ...
    setTimeout(() => {
      this.connectMonitoring(this.monitoringUrl);
  ...
  notifyMonitoringListeners(event) {
    console.log('notifyMonitoringListeners: Calling callbacks');
    this.monitoringListeners.forEach(callback => {
      try {
        console.log('notifyMonitoringListeners: Calling callback', callback);
        callback(event);
      } catch (error) {
